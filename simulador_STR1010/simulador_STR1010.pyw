...
def send_data_to_server():
    ...
    send_data = calculate_gps_string(imei, alarme, sat, hdop, vel, odo, entradas, saidas, lat, long, current_date_time)
...
def calculate_gps_string(imei_value, alarme_value, sat_value, hdop_value, vel_value, odo_value, entradas, saidas, lat, long, current_date_time):
    ...
    dynamic_part = f",{imei_value},000,{alarm_code},,{current_date_time},A,{lat},{long},{sat_value},{hdop_value},{vel_value},167,900,{odo_value},724|2|8182|031DC00A,30,003D,{entradas},{saidas},099E|019C|0000|0000,128,,,"
...
def apply_settings():
    ...
    send_data = calculate_gps_string(imei, alarme, sat, hdop, vel, odo, entradas, saidas, lat, long, time_offset)
...
root = tk.Tk()
root.title("SETERA - Simulador STR1010 V1.0")
root.state('zoomed')
...
intervalo_label = tk.Label(lower_frame, text="Intervalo de envio(seg):")
intervalo_label.pack(side=tk.LEFT, padx=5, pady=5)
intervalo_var = tk.StringVar()
intervalo_combobox = ttk.Combobox(lower_frame, textvariable=intervalo_var, state="readonly", width=3)
